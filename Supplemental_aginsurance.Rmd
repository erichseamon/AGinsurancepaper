...
Table S1. Insurance loss records that were acquired from the USDA Risk Management Agency (RMA).  Each record represents an individual insurance claim.
<br></br>

Table S2. USDA Risk Management Agency aggregated dataset, derived from the original insurance loss files. Here we have summarized claims by year, county, commodity, and damage cause.
<br></br>
...
Figure S1. PNW agricultural insurance loss by year, 1989 to 2015.
<br></br>

Figure S2. PNW agricultural insurance loss by year: 2001 to 2015.
<br></br>

Figure S3. PNW agricultural insurance loss by damage cause: 2001 to 2015.
<br></br>

Figure S4. PNW agricultural insurance loss by commodity: 2001 to 2015
<br></br>

Figure S5. Top panel: biplot of principal components for PNW insurance loss, by county, with commodity as the factor loadings. Bottom panel: Scree plot. Data from 2001 to 2015 is used.
<br></br>

Figure S6. Top panel: biplot of principal components for PNW insurance loss, for all commodities by year, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 to 2015 is used.
<br></br>

Figure S7. Top panel: biplot of principal components for PNW insurance loss, for all commodities by month, with damage cause as the factor loadings. Bottom panel: Scree plot Data from 2001 is 2015 is used.
<br></br>

Figure S8. Top panel: biplot of principal components for PNW insurance loss, for wheat by year, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used.
<br></br>

Figure S9. Top panel: biplot of principal components for PNW insurance loss, for wheat by county, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used.
<br></br>

Figure S10. Top panel: biplot of principal components for PNW insurance loss, for apples by county, with damage caus eas the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used.
<br></br>

Figure S11. Top panel: biplot of principal components for PNW insurance loss, for barley by county, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used.
<br></br>

### Inland Pacific Northwest (iPNW) Supplemental Figures

Figure S12. iPNW agricultural insurance loss by year, 2001 to 2015.
<br></br>

Figure S13. iPNW agricultural insurance loss by commodity, 2001 to 2015.
<br></br>

Figure S14. iPNW agricultural insurance loss by damage cause, 2001 to 2015.
<br></br>

Figure S15. iPNW agricultural insurance loss for apples by county: 2001 to 2015.
<br></br>

Figure S16. iPNW agricultural insurance loss for apples by year: 2001 to 2015.
<br></br>

Figure S17. iPNW agricultural insurance loss for apples by damage cause: 2001 to 2015.
<br></br>

Figure S18. iPNW stacked barplot of annual apples agricultural insurance loss, by top damage causes, 2001 to 2015.
<br></br>

Figure S19. iPNW agricultural insurance loss due to hail, frost, and freeze, for apples, by county, 2001 to 2015.
<br></br>

Figure S20. iPNW agricultural insurance loss due to hail, frost, and freeze, for apples, by county, 2013.
<br></br>

Figure S21. iPNW agricultural insurance loss due to hail, frost, and freeze, for apples, by county, 2012.
<br></br>

Figure S22. iPNW agricultural insurance loss due to hail, frost, and freeze, for apples, by county, 2006.
<br></br>

Figure S23. iPNW agricultural insurance loss due to hail, frost, and freeze, for apples, by county, 2015.
<br></br>

Figure S24. Top panel: biplot of principal components for iPNW insurance loss, for all commodities by county, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used

Figure S25. Top panel: biplot of principal components for iPNW insurance loss, for all commodities by month, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used
<br></br>

Figure S26. Top panel: biplot of principal components for iPNW insurance loss, for wheat by year, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used
<br></br>

Figure S27. Top panel: biplot of principal components for iPNW insurance loss, for wheat by county, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used
<br></br>

Figure S28. Top panel: biplot of principal components for iPNW insurance loss, for barley by county, with damage cause as the factor loadings. Bottom panel: Scree plot. Data from 2001 is 2015 is used
<br></br>

### Alternative Modeling Supplemental Figures

Figure S29. Top panel: biplot of insurance loss for the PNW, for wheat by county, with damage cause as the factor loadings.  Uses a Kmeans technique for grouping. Bottom panel: Scree plot. Data from 2001 is 2015 is used.
<br></br>

Figure S30. Hierarchical clustering dendrogram of iPNW counties, using the first two principal components of the aforementioned dimensionality reduction exercise.  This clustering method provides an alternative approach as compared to Kmeans clustering.
<br></br>
...
```{r message=FALSE, warning=FALSE, error=TRUE, echo = FALSE, results = FALSE, fig.keep='none', fig.width = 8, fig.height = 7, fig.cap=paste("Pacific Northwest study area, which includes agricultural regions for the inland Pacific Northwest, the southern Idaho valley, and the Willamette valley.")}
...
```{r message=FALSE, warning=FALSE, echo= FALSE, error=TRUE, results = FALSE, fig.keep='none', fig.width = 8, fig.height = 6, fig.cap=paste("24 county inland Pacific Northwest (iPNW) study area. ")}
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_wheat, center = TRUE, scale = TRUE), frame = TRUE, frame.type = 'norm', data = RMA_damage_PNW_transformed_wheat, colour = 'state', loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_wheat)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: PNW wheat insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_apples, center = TRUE, scale = TRUE), frame = TRUE, frame.type = 'norm', data = RMA_damage_PNW_transformed_apples, colour = 'state', loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_apples)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: PNW apples insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_barley, center = TRUE, scale = TRUE), frame = TRUE, frame.type = 'norm', data = RMA_damage_PNW_transformed_barley, colour = 'state', loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_barley)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: PNW barley insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_wheat_year_factor, center = TRUE, scale = TRUE),  data = RMA_damage_PNW_exogenous_wheat_year_factor,  loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_wheat_year_factor)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: iPNW wheat insurance loss by year with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_barley, center = TRUE, scale = TRUE), data = RMA_damage_PNW_transformed_barley,  loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_barley)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: iPNW barley insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_wheat, center = TRUE, scale = TRUE), data = RMA_damage_PNW_transformed_wheat, loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_wheat)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: iPNW wheat insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_apples, center = TRUE, scale = TRUE), data = RMA_damage_PNW_transformed_apples, loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_apples)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: iPNW apples insurance loss by county with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif"))
