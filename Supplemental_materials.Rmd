---
title: 'Supplemental Materials for: Spatiotemporal Analysis of Agricultural Insurance Loss and Causes of Damage across the Inland Pacific Northwest Region of the United States'
#author: "Erich Seamon, Paul E. Gessler, John T. Abatzoglou, Philip W. Mote, Stephen S. Lee"
date: "September 2023"
subtitle: 'The material contained herein is supplementary to the article named in the title and submitted to the journal, Agriculture, Ecosystems and Environment.'
...
Table S1. Example of insurance loss records that were acquired from the USDA Risk Management Agency (RMA).  Each record represents an individual insurance claim.  Full datasets are available at https://github.com/erichseamon/AGinsurancepaper as well as via the following DOI:
<br></br>
...
rma2016 <- read.csv("/tmp/seamon/RMA_originaldata/2016.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2017 <- read.csv("/tmp/seamon/RMA_originaldata/2017.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2018 <- read.csv("/tmp/seamon/RMA_originaldata/2018.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2019 <- read.csv("/tmp/seamon/RMA_originaldata/2019.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2020 <- read.csv("/tmp/seamon/RMA_originaldata/2020.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2021 <- read.csv("/tmp/seamon/RMA_originaldata/2021.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2022 <- read.csv("/tmp/seamon/RMA_originaldata/2022.txt", sep = "|", header = FALSE, strip.white = TRUE)
