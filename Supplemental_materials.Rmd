---
title: 'Supplemental Materials for: Agricultural Insurance Loss Relationships to Climatic Damage Cause Across the Inland Pacific Northwest Region of the United States'
#author: "REDACTED FOR REVIEW"
date: "September 2023"
subtitle: 'The material contained herein is supplementary to the article named in the title and submitted to the journal, Environmental Research Letters.' 
...
Table S1. Example of insurance loss records that were acquired from the USDA Risk Management Agency (RMA).  Each record represents an individual insurance claim.  Full datasets are available at \<REDACTED for review\> as well as via the following DOI: \<REDACTED for review\>
<br></br>
