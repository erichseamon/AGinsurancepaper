...
destfile <- "./data/RMA_originaldata/RMA_originaldata_txt.zip"
...
palouse_sumloss_1989_2015 <- aggregate(RMA_PNW$loss, list(RMA_PNW$commodity), FUN = "sum")
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_year_factor, center = TRUE, scale = TRUE),  data = RMA_damage_PNW_exogenous_year_factor, loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 3, label = FALSE, label.size = 2, legend = FALSE)  + theme_bw()   + geom_text(vjust=-1, label=rownames(RMA_damage_PNW_exogenous_year_factor)) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: PNW insurance loss by year with damage cause loadings ") + theme(plot.title = element_text(size =12)) + theme(axis.title.y = element_text( size=12), axis.title.x = element_text(size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1), axis.text.y = element_text(size=rel(1.5), hjust = 1))
...
graphics::title(main="IPNW total insurance loss: 2001 to 2015", line = 1, cex.main = 1.5, adj = 0)
...
graphics::title(main="IPNW total insurance loss by commodity: 2001 to 2015", line = 1, cex.main = 1.5, adj = 0)
...
graphics::title(main="IPNW total insurance loss by damage cause: 2001 to 2015", line = 1, cex.main = 1.5, adj = 0)
...
graphics::title(main="Apples insurance loss by damage cause: 2001 to 2015", line = 2, cex.main = 1.5, adj = 0)
...
#RMA_damage_PNW_transformed_year$statecounty <- paste(RMA_damage_PNW_transformed_year$county, "_", RMA_damage_PNW_transformed_year$state, sep="")
rownames(RMA_damage_PNW_transformed_month) <- RMA_damage_PNW_transformed_month$month
RMA_damage_PNW_exogenous_month <- RMA_damage_PNW_transformed_month[,2:28]
...
RMA_damage_PNW_wheat_year <- subset(RMA_IPNW, commodity == "WHEAT")
RMA_damage_PNW_transformed_wheat_year <- dcast(RMA_damage_PNW_wheat_year, year ~ damagecause, value.var = c("loss"), sum)
#RMA_damage_PNW_transformed_year$statecounty <- paste(RMA_damage_PNW_transformed_year$county, "_", RMA_damage_PNW_transformed_year$state, sep="")
rownames(RMA_damage_PNW_transformed_wheat_year) <- RMA_damage_PNW_transformed_wheat_year$year
RMA_damage_PNW_exogenous_wheat_year <- RMA_damage_PNW_transformed_wheat_year
...
RMA_damage_PNW_exogenous_wheat_year_factor <- cbind(RMA_damage_PNW_exogenous_wheat_year[,3:4], RMA_damage_PNW_exogenous_wheat_year[7], RMA_damage_PNW_exogenous_wheat_year[9], RMA_damage_PNW_exogenous_wheat_year[,12:15], RMA_damage_PNW_exogenous_wheat_year[17:18])
fit <- princomp(RMA_damage_PNW_exogenous_wheat_year_factor, cor=TRUE)
fit2 <- prcomp(RMA_damage_PNW_exogenous_wheat_year_factor, cor=TRUE, center = TRUE, scale = TRUE)
...
plot1 <- ggplot2::autoplot(prcomp(RMA_damage_PNW_exogenous_wheat_year_factor, center = TRUE, scale = TRUE),data = kclust, colour = 'k.clust',   loadings = TRUE, loadings.label = TRUE, loadings.label.size  = 4, label = FALSE, label.size = 2, legend = FALSE,loadings.label.repel=TRUE)  +  theme_bw()   + ggrepel::geom_text_repel(label=rownames(RMA_damage_PNW_exogenous_wheat_year_factor), segment.colour = NA, size=4) + theme(legend.position = "none") + ggtitle("Principal Components Analysis: iPNW wheat insurance loss by year with \ndamage cause loadings ") + theme(plot.title = element_text(size =12, family = "Serif")) + theme(axis.title.y = element_text(family = "Serif", size=12), axis.title.x = element_text(family = "Serif", size = 12), axis.text.x = element_text(size=rel(1.5), hjust = 1, family = "Serif"), axis.text.y = element_text(size=rel(1.5), hjust = 1, family = "Serif")) + ggforce::geom_mark_ellipse(aes(color = k.clust)) + theme(legend.position = 'bottom') + coord_equal() +ylim(-.80, .50) 
...
RMA_damage_PNW_barley <- subset(RMA_IPNW, commodity == "BARLEY")
...
RMA_damage_PNW_wheat <- subset(RMA_IPNW, commodity == "WHEAT")
...
usePackage("ggfortify")
usePackage("reshape2")
RMA_damage_PNW_apples <- subset(RMA_IPNW, commodity == "APPLES")

RMA_damage_PNW_transformed_apples <- dcast(RMA_damage_PNW_apples, county + state ~ damagecause, value.var = c("loss"), sum)
RMA_damage_PNW_transformed_apples$statecounty <- paste(RMA_damage_PNW_transformed_apples$county, "_", RMA_damage_PNW_transformed_apples$state, sep="")
rownames(RMA_damage_PNW_transformed_apples) <- RMA_damage_PNW_transformed_apples$statecounty
RMA_damage_PNW_exogenous_apples <- RMA_damage_PNW_transformed_apples[,3:22]
